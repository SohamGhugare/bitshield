  ...
  return (
    <>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-2">
                Min: {selectedPolicy.minAmount} sBTC | Max: {selectedPolicy.maxAmount} sBTC
              </p>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1.5">
                  {premium.toFixed(8)} sBTC ({selectedPolicy.premiumRate}% annual rate)
                </p>
              </div>
            </div>
          </div>
      ...
      <SuccessDialog
        ...
        message={`Successfully purchased ${amount} sBTC coverage for ${duration} days in ${selectedPolicy.name}`}
      />
    </>
  );
} 